...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-tools/trieTools/zeroBalanceSystemAccountChecker/common"
...
func TestReadPemsData_RealData(t *testing.T) {
	...
	addrShard0, err := data.NewAddressFromBech32String("drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf")
	require.Nil(t, err)
	skShard0, err := hex.DecodeString("413f42575f7f26fad3317a778771212fdb80245850981e48b58a4f25e344e8f9")
	require.Nil(t, err)

	addrShard1, err := data.NewAddressFromBech32String("drt1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaq889n6e")
	require.Nil(t, err)
