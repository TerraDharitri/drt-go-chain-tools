...
import (
	...
	statisticsDisabled "github.com/TerraDharitri/drt-go-chain/common/statistics/disabled"
	...
	pruningManagerDisabled "github.com/TerraDharitri/drt-go-chain/state/storagePruningManager/disabled"
	...
	"github.com/TerraDharitri/drt-go-chain-tools/trieTools/trieToolsCommon/components"
...
// WalletHRP represents the constant for the DharitrI wallets HRP prefix
const WalletHRP = "drt"
...
func GetMaxDBValue(parentDir string, log logger.Logger) (int, error) {
	contents, err := os.ReadDir(parentDir)
	if err != nil {
		return 0, err
	}
