...
This tool is used to check that the dcdt type has been sent to all shards
# How to use

1. compile the binary by issuing a `go build` command in drt-go-chain-tools/trieTools/updateTokenIdChecker directory
