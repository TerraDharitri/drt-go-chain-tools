...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-tools/trieTools/zeroBalanceSystemAccountChecker/mocks"
...
func TestReadTokensWithNonce(t *testing.T) {
	...
	delete(adr1Tokens, "dcdt1-rand")
	delete(sysAccTokensShard0, "dcdt1-rand")
	delete(sysAccTokensShard1, "dcdt2-rand")
