...
1. compile the binary by issuing a `go build` command in numbat-tools-go/trieTools/accountStorageExporter directory
...
3. start the app with the following parameters: 
   `./accountStorageExporter --log-level *:DEBUG --log-save --hex-roothash c93be73e9e1d8918ea240523372bc3094aa4bbc7221000300a493a6ae593b348 --address drt1qqqqqqqqqqqqqpgqhe8t5jewej70zupmh44jurgn29psua5l2jpsv0u330` 
   
where `c93be73e9e1d8918ea240523372bc3094aa4bbc7221000300a493a6ae593b348` is the required trie hash to be checked and drt1qqqqqqqqqqqqqpgqhe8t5jewej70zupmh44jurgn29psua5l2jpsv0u330 is the address to export the storage for
