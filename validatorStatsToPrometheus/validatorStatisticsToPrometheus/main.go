...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-tools/jsonToPrometheus/collector"
	"github.com/TerraDharitri/drt-go-chain-tools/jsonToPrometheus/config"
...
`
	...
	apiURL = cli.StringFlag{
		...
		Value: "https://testnet-api.dharitri.org",
	}
...
func attachFileLogger(log logger.Logger, logsCfg config.LogsConfig) (factory.FileLoggingHandler, error) {
	...
	args := file.ArgsFileLogging{
		...
		LogFilePrefix:   "dharitri-validator-statistics",
	}
